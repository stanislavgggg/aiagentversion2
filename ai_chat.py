"""
AI Chat router — multi-turn conversation.
Claude fetches Mailchimp data via Composio MCP automatically.
...
async def send_message(req: ChatRequest, db: AsyncSession = Depends(get_db)):
    ...
    # Load history (last 20 messages = 10 turns)
...
async def example_questions():
    return {
        "examples": [
            ...
            "Напиши новое письмо для Sportsbook аудитории в Хорватии на основе наших лучших кампаний",
            "Сравни результаты Casino vs Sportsbook кампаний по всем GEO",
            "Сгенерируй 3 новых угла для newsletter на основе кампаний с лучшим CTR",
            "В какие дни недели наши кампании показывают лучшие результаты?",
            "Предложи A/B тест для следующей кампании в Литве",
            "Какой стиль subject line работает лучше всего — с emoji или без?",
