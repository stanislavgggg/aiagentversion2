...
Claude fetches real Mailchimp data via MCP, then generates content.

POST /api/generate/newsletter
POST /api/generate/subject-lines
POST /api/generate/ab-test
POST /api/generate/ctas
...
class GenerateRequest(BaseModel):
    geo: str
    audience_type: str   # Casino | Sportsbook | VIP
    offer: str
